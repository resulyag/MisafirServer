...
socket.on('connect', function () {
  ...
  socket.on('mqtt', function (msg) {
    ...
    if (mMessage.length > 20000) {
      mMessage = ""
    }

    var mmsg = msg.payload
    try {
      if (!(/^[a-zA-Z]+$/.test(mmsg))) {
        // Validation failed
        mmsg = String.fromCharCode.apply(null, new Uint8Array(msg.payload));
      }
    ...
    mMessage = mMessage + "<p><b>_TOPIC:</b> <i>" + msg.topic + "</i>, <b>_DATA:</b> <i>" + msg.payload + "</i>, <b>_STR:</b> <i>"+mmsg+"</i></p> </br>"
